...
def recommend_alternatives_task(
    ...
    return Task(
        description=(
            ...
            f"5. Show why these alternatives work and path to upgrade\n"
            f"6. Be encouraging and practical\n"
            f"{constraint_msg}"
        ),
        expected_output=(
            "List of 1-3 suitable alternative products that match customer profile\n"
